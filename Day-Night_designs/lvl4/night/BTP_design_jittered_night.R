...
IN_MAT <- as.matrix(cbind(q_inv,tpot_inv,lwp,tpot_pbl,pbl,ks,as,cs,rdry_AS_eff));
...
colnames(DESIGN) <- c("q_inv","tpot_inv","lwp","tpot_pbl","pblh","ks","as","cs","rdry_AS_eff")
